...
comment on column member.address1 is '회원 도로명 기본 주소';
comment on column member.address2 is '회원 도로명 상세 주소';
comment on column member.useyn is '회원 가입 여부';
comment on column member.indate is '회원 가입 일자';
...
-- 파일 암호화(중복 방지)
-- image      varchar2(200 char)  default 'default.jpg', -- 원본 이미지
-- thumb_image varchar2(200 char)  default 'default.jpg', -- 썸네일 이미지
...
insert into product(pseq, name, kind, price1, price2, price3, content, image, thumb_image) values(
product_seq.nextval, '크로그다일부츠', '2', '40000', '50000', '10000', '오리지날 크로그다일부츠 입니다.', 'w2.jpg', 'w2.jpg');
insert into product(pseq, name, kind, price1, price2, price3, content, image, thumb_image, bestyn) values(
product_seq.nextval, '롱부츠', '2', 40000, 50000, 10000,'따뜻한 롱부츠 입니다.', 'w-28.jpg', 'w-28.jpg', 'n');
insert into product(pseq,  name, kind, price1, price2, price3, content, image, thumb_image, bestyn) values( 
product_seq.nextval, '힐', '1', '10000', '12000', '2000', '여성용전용 힐', 'w-26.jpg', 'w-26.jpg','n');
insert into product(pseq,  name, kind, price1, price2, price3, content, image, thumb_image, bestyn) values(
product_seq.nextval, '슬리퍼', '4', '5000', '5500', '500', '편안한 슬리퍼입니다.', 'w-25.jpg', 'w-26.jpg','y');
insert into product(pseq,  name, kind, price1, price2, price3, content, image, thumb_image, bestyn) values(
product_seq.nextval, '회색힐', '1', '10000', '12000', '2000', '여성용전용 힐', 'w9.jpg', 'w-26.jpg','n');
insert into product(pseq,  name, kind, price1, price2, price3, content, image, thumb_image) values(
product_seq.nextval, '여성부츠', '2', '12000', '18000', '6000', '여성용 부츠', 'w4.jpg', 'w-26.jpg');
insert into product(pseq,  name, kind, price1, price2, price3, content, image, thumb_image,bestyn) values(
product_seq.nextval,  '핑크샌달', '3', '5000', '5500', '500', '사계절용 샌달입니다.', 'w-10.jpg', 'w-26.jpg','y');
insert into product(pseq,  name, kind, price1, price2, price3, content, image, thumb_image,bestyn) values(
product_seq.nextval, '슬리퍼', '3', '5000', '5500', '500', '편안한 슬리퍼입니다.', 'w11.jpg', 'w-26.jpg','y');
insert into product(pseq,  name, kind, price1, price2, price3, content, image, thumb_image) values(
product_seq.nextval,  '스니커즈', '4', '15000', '20000', '5000', '활동성이 좋은 스니커즈입니다.', 'w1.jpg', 'w-26.jpg');
insert into product(pseq,  name, kind, price1, price2, price3, content, image, thumb_image, bestyn) values(
product_seq.nextval,  '샌달', '3', '5000', '5500', '500', '사계절용 샌달입니다.', 'w-09.jpg','n');
insert into product(pseq,  name, kind, price1, price2, price3, content, image, thumb_image, bestyn) values(
product_seq.nextval,  '스니커즈', '5', '15000', '20000', '5000', '활동성이 좋은 스니커즈입니다.', 'w-05.jpg','w-26.jpg','n');
...
m.zip_num, m.address1, m.address2, m.phone, p.name pname, p.price2, d.result   
...
as
select pseq, name, price2, image, thumb_image 
from( select rownum, pseq, name, price2, image, thumb_image 
      from product  
      where bestyn='y' 
