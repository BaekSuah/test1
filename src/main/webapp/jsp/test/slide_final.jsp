...
<div id="slide_pnl">
    ...
    <img id="s1" src="${contextPath}/img/slide/en.jpg" class="slider_image"/>
    <img id="s2" src="${contextPath}/img/slide/min.jpg" class="slider_image"/>
    <img id="s3" src="${contextPath}/img/slide/chang.jpg" class="slider_image"/>
    <img id="s4" src="${contextPath}/img/slide/hyun.jpg" class="slider_image"/>
    <!-- <img id="s5" src="${contextPath}/img/slide/group1.jpg" class="slider_image"/> -->
