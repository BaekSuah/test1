...
<div id="wrap">
	...
	<div id="flag_box" class="offcanvas offcanvas-start">
		<div class="offcanvas-header">
	    	<h1 class="offcanvas-title">플래그 변수 현황</h1>
	    	<button type="button" class="btn-close" data-bs-dismiss="offcanvas"></button>
	  	</div>
	<div class="offcanvas-body">
...
<!--헤더파일 들어가는 곳 시작 -->
  <header>
    ...
    <div id="logo">
      <a href="${contextPath}/">
        <img src="<c:url value="/img/logo.png" />" width="180" height="100" alt="nonageshop">
      </a>  
    </div>
    <!--로고 들어가는 곳 끝-->     
    ...
    <nav id="top_menu">
      <ul>
        <li>
          <a href="${contextPath}/product/category?kind=1">Heels</a>
        </li>  
        <li>
          <a href="${contextPath}/product/category?kind=2">Boots</a>
        </li>  
        <li>
          <a href="${contextPath}/product/category?kind=3">Sandals</a>
        </li> 
        <li>
          <a href="${contextPath}/product/category?kind=4">Sneakers</a>
        </li> 
        <li>
          <a href="${contextPath}/product/category?kind=5">On Sale</a>
        </li>  
      </ul>
    </nav>
    <div class="clear"></div>
