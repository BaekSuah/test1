...
$(function() {
	...
	$("body").on("click", "#new_left_btn" , function(){
	    ...
	    console.log("현재 첫요소 : " + $("#newProduct div[id^=i=newItem]:first").html());
	  ...
	  <div id="main_img" class="carousel slide" data-bs-ride="carousel">
		  ...
		  <div class="carousel-inner">
		    <div class="carousel-item active">
		      <img src="${contextPath}/img/main/main1.jpg" class="d-block" style="width:100%">
		    </div>
		    <div class="carousel-item">
		      <img src="${contextPath}/img/main/main2.jpg" class="d-block" style="width:100%">
		    </div>
		    <div class="carousel-item">
		      <img src="${contextPath}/img/main/main3.jpg" class="d-block" style="width:100%">
		    </div>
		    <div class="carousel-item">
		      <img src="${contextPath}/img/main/main4.jpg" class="d-block" style="width:100%">
		    </div>
		  </div>
	      ...
	      <c:forEach var="i" begin="0" end="3">
				...
				<div id="newItem${i}">
					...
					<c:choose>
						...
						<%-- 상품 없을 경우 --%>
						<c:otherwise>
							<img src="<%=request.getContextPath() %>/img/blank_tranparent.jpg">
							<h6>&nbsp;</h6>    
							<p>&nbsp;</p>
						</c:otherwise>
