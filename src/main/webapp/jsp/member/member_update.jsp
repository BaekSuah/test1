...
if(msg.trim() != '') {
 ...
 <article id="update_box">

    <h2>Update Us</h2>

	<div style="background:yellow; width:100%; height:100px; overflow:auto; font-size:9pt">
    ...
    <form id="update" action="${contextPath}/member/update_proc" method="post" name="formm">
      ...
      <fieldset>
        ...
        <!-- 아이디 -->
 		<div class="row my-2">
        	...
        	<div class="col-8 ">
        		<input type="text" id="id" name="id" class="form-control bg-light" readonly value="${LOGIN_USER.id}" >
        	</div>
        </div>   
 		...
 		<!-- 신규(변경) 비밀번호 -->
  		<div class="row my-2">
        	...
        	<div class="col-8">
        		<input type="password" id="pwd" name="pwd" class="form-control" value=" " maxlength="20" >
        	</div>
        </div> 
		...
		<div class="row text-danger" >
 		...
 		<!-- 비밀번호 확인 -->
  		<div class="row my-2">
        	...
        	<div class="col-8">
        		<input type="password" id="pwdCheck" name="pwdCheck" class="form-control" value=" " maxlength="20" >
		...
		<div class="row text-danger" >
 		...
 		<!-- 회원 이름 -->
  		<div class="row my-2">
        	...
        	<div class="col-8">
        		<input type="text" id="name" name="name" class="form-control bg-light" readonly value="${LOGIN_USER.name}">
        	</div>
        </div> 
		...
		<div class="row text-danger" >
 		...
 		<!-- 연락처 -->
  		<div class="row my-2">
        	...
        	<div class="col-8">
        		<input type="text" id="phone" name="phone" class="form-control" value="${LOGIN_USER.phone}">
        	</div>
        </div>
      ...
      <fieldset>
        ...
        <legend class="update_title">Optional</legend>
 		...
 		<!-- 우편번호 -->
  		<div class="row my-2">
        	...
        	<div class="col-2">
        		<input type="text" id="zipNum" name="zipNum" class="form-control bg-light" readonly value="${LOGIN_USER.zipNum}">
        	</div>
        	<div class="col-2">
 		...
 		<!-- 회원 기본 주소 -->
  		<div class="row my-2">
        	...
        	<div class="col-8">
        		<input type="text" id="address1" name="address1" class="form-control bg-light" readonly value="${LOGIN_USER.address1}">
        	</div>
		</div>
 		...
 		<!-- 회원 상세 주소 -->
  		<div class="row my-2">
        	...
        	<div class="col-8">
        		<input type="text" id="address2" name="address2" class="form-control" value="${LOGIN_USER.address2}">
        	</div>
        </div> 
		...
		<div class="row text-danger" >
			<div class="col-4"></div>
				<div class="col-8" id="address_err_msg" >
					${address_err_msg}			
				</div>
		</div>
